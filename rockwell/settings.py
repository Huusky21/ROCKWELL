...
SECRET_KEY = 'django-insecure-_q7*o_l=lj0m$7_4-5mhuoe3!m6=$c2nsf#8@)3t+4(+znrys-'
...
# Email (alertas de inventario de huacales)
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
DEFAULT_FROM_EMAIL = 'inventario-huacales@rockwell.local'
# Para producción, reemplazar por SMTP. Ejemplo:
